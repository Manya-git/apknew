...
class EditCurrrencyView extends GetView<CurrencyController> {
  final String currencyName;
  final String currencySymbol;

  const EditCurrrencyView({Key? key, required this.currencyName, required this.currencySymbol}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    CurrencyController controller = Get.put(CurrencyController());
    controller.updateSelectedIndex(null);
    return Scaffold(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Container(
                        alignment: Alignment.center,
                        child: Text(
                          AppString().change_currency(context),
                ...
                return PrimaryActionButton(
                  ...
                  onTap: () => {
                    if (_.selectedIndex != null)
                      {
                        _.updateCurrency(_.currencyList[controller.selectedIndex].currency!,
                            _.currencyList[_.selectedIndex].currencyName!, "edit")
                      }
                  },
                  isLoading: false,
      ...
      child: Column(
        ...
        children: [
          Container(
              ...
              child: Text(AppString().selected_currency(context),
                  style: FontUtils.SF.copyWith(
                      fontSize: Dimens.currentSize(context, 12, 14, 16),
                      color: Colors.white,
                      fontWeight: FontWeight.w400,
